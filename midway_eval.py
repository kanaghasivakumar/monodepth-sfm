...
def evaluate(config):
    ...
    # Point to the duplicated presentation checkpoint
    config['resume_ckpt'] = 'checkpoints/presentation_checkpoint.pth'
    ...
    # Restore ImageNet normalization
    ...
    with torch.no_grad():
        for rgb_path, velo_path, calib_dir in tqdm(test_files):
            ...
            # Apply normalization before sending to device
